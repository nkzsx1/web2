...
(function (_this,_func) {
    ...
    function sendGetDataMsg(name,callback,param){
        ...
        sendMsg.call(this,{
            ...
            name:name,
            param:param,
            origin:decodeURI(window.location.href)
        });
    }
    //事件触发
    ...
    objClass.prototype={
        ...
        setTabCloseable:function(title,status){
            sendFuntionMsg.call(this,"setTabCloseable",arguments);
        },
        refreshTab:function(){
            sendFuntionMsg.call(this,"refresh",arguments);
        },
        isExistTab:function(name,callback){
            sendGetDataMsg.call(this,'getIframe',callback,name);
        },
        isExistDialog:function(name,callback){
            sendGetDataMsg.call(this,'getDialog',callback,name);
        },
        destroyTab:function(){
        ...
        on: function(type, listener){
            ...
            for(var i=0;i<this._listeners[type].length;i++){
                if(this._listeners[type][i].toString() ==listener.toString()){
                    return false
                }
            }
        ...
        /*NGCSBASE-1461 知识库提出需求，在crossAPI暴露switchTab方法
         * 2018-03-17 吴迎科 start
         * */
        switchTab:function(){
            sendFuntionMsg.call(this,"switchTab",arguments);
        },
        /*NGCSBASE-1461 知识库提出需求，在crossAPI暴露switchTab方法
         * 2018-03-17 吴迎科 end
         * */
