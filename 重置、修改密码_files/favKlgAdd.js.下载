define(['Util', 'knowledgeTree', 'text!modules/personalCenterNew/favKlgAdd.tpl', 'js/personalCenter/MyAlert', 'js/constants/constants'
    ...
    var selectCatl = function(title,favrtKnwlgId,targetObj){
        ...
        $("#default-catalog").click(function(){
            ...
            Util.ajax.ajax({
                ...
                success: function (data) {
                    ...
                    var node = zTreeObj.getNodesByParam("catlNm","前台展示",null)[0];
        ...
        $(".submit-favorite").click(function(){
            ...
            if($("#catalog-tree ul li span input").length>0){  //如果是新建文件夹后点“确定”
                ...
                var data = {'favrtKnwlgNm':fkname,'favrtKnwlgId':favrtKnwlgId,'catlNm':name,'parentCatlId':parentCatlId};
                Util.ajax.postJson(Constants.AJAXURL+"/klgFavrtInfo/saveKlgByNode",data,function(json){
                    if(json.returnCode == 0){
